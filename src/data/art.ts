...
export type ArtPiece = {
  slug: string; // used for the individual artwork URL: /art/<slug>
  title: string;
...
// entry below. No component code needs to change — the gallery, filters,
// lightbox, individual artwork pages, and sitemap all pick it up automatically.
//
// Example:
// {
//   slug: "tiger-study",
