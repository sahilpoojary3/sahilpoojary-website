...
export const profile = {
  ...
  tagline:
    "I'm building a career at the crossroads of operations, marketing and digital transformation — currently splitting my time between an MBA, a non-profit I help direct, and running events for a growing hospitality brand.",
